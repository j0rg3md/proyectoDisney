                    ...
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                            Modificar Parque
                         		...
                         		<form name="formModificarParque" action="crud/updateParque.php" method="post" onSubmit="return validacionModificarParque();">
    		                      <legend>Modificar parque</legend>
				           ...
				           <label>Lugar:</label> 
								         	<input type="text" id="lugar" name="lugar" size="20" > <br><br>
				           
								        
								        	<input type="SUBMIT" class="btn-group-vertical" value="Modificar Datos"/>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Parques / Modificar
                            </li>
                        </ol>
                  </div>
                </div>
