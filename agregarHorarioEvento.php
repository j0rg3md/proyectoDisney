    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                      <h1 class="page-header">Agregar Horario Evento</h1>
                      <form action="crud/insertarHorarioEvento.php" method="post">
									<br>
                  <br>
                  <label>Evento:</label>
                  <?php $rows = $tra->get_evento();  ?>
                  <select name="codigoEvento">
                  ...
                  <br><br>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Agregar Horario Evento
                            </li>
                        </ol>
                  </div>
                </div>
