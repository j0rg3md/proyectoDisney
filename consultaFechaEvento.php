...
require_once 'crud/class.php';
  ...
  $fechaEvento = $tra->get_rango_fecha_evento($codigoEvento);
  $fechaEventoInicio = $fechaEvento['primer_dia'];
  $fechaEventoFin = $fechaEvento['ultimo_dia'];
?>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                      <h1 class="page-header">Fechas de los Eventos</h1>
                      <form action="horarioEvento.php" method="post">
                        <?php echo "<input type='hidden' name='codigoEvento' value='".$codigoEvento."' />"; ?>


									<br>
                  <br>
                  <label>Fechas Disponibles Parque: </label>
                    <?php echo "<input type='date' name='fecha' min=".$fechaEventoInicio." max=".$fechaEventoFin."><br><br>" ?>


                    <br>
                      <br>

                                  <input type="submit" name="consultar" id="consultar" value="Consultar Horarios">
                                  <input type="submit" name="eliminar" id="eliminar" value="Eliminar Fecha">
                                  <br><br>

					                        </form>
							<td><a href="consultaHorarioEvento.php">Volver Atras</a></td>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="index.html">Inicio</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-file"></i> Horarios / Consulta Horario Evento / Fechas
                            </li>
                        </ol>
                  </div>
                </div>
