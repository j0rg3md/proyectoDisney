            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                      ...
                      <form name="formAgregarParque" action="crud/insertarParque.php" method="post" onSubmit="return validacionAgregarParque();">
                         
						   <label>Nombre:</label>
  											<input name="nombre" type="text" id="nombre"  > <br><br>

				           <label>Descripcion:</label>					
								        	<input name="descripcion" type="textarea" rows="10" cols="40" id="descripcion" size="120"> <br><br>
                                            
                           <label>Direccion:</label>								        
								         	<input type="text" id="direccion" name="direccion" > <br><br>
								        
				           <label>Fecha de Fundación:</label>
                                        	<input type="date" id="fechaF" name="fecha_fundacion"  > <br><br>
				           
				           <label>Lugar:</label> 
								         	<input type="text" id="lugar" name="lugar" > <br><br>
				           
								        
								        	<input type="SUBMIT" class="btn-group-vertical" value="Agregar Parque"/>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Parques / Agregar
                            </li>
                        </ol>
                  </div>
                </div>
