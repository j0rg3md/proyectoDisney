                    ...
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                         ...
                         <fieldset style="width:480px" 	>
    		                      <legend>Eliminar Evento Especial</legend>
	    	                          <form action="crud/eliminarEventoEspecial.php" method="post" onSubmit="return validacionEliminarEventoEspecial();">
	    		                             <div>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Eventos Especiales / Eliminar
                            </li>
                        </ol>
                    </div>
                </div>
