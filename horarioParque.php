...
require_once 'crud/class.php';
  ...
  $fecha = ($_POST['fecha']);
  $horarioParque = $tra->get_horario_parque($fecha,$codigoParque);
  $hora_inicio = $horarioParque['hp_hora_inicio'];
  $hora_fin = $horarioParque['hp_hora_fin'];
  $codigoHorario = $horarioParque['hp_codigo'];
?>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                      <h1 class="page-header">Consulta de Horario Parque dia <?php echo $fecha ?></h1>
                      <form action="crud/eliminarHorarioParque.php" method="post">
                        <?php echo "<input type='hidden' name='codigoHorario' value='".$codigoHorario."' />"; ?>
