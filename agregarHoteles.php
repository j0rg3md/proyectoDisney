            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                      ...
                      <form name="formAgregarHotel" action="crud/insertarHotel.php" method="post" onSubmit="return validacionAgregarHotel();">
				           ...
				           <label for="id">Parque:</label>
                                              <?php $rows = $tra->get_lugares();  ?>
					                                          <select name ="codigoP" id="codigoP"><option value="0">Seleccione..
								        	...
								        	<input type="SUBMIT" class="btn-group-vertical" value="Agregar Hotel"/>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Hoteles / Agregar
                            </li>
                        </ol>
                  </div>
                </div>
