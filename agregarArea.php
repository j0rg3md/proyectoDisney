            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                      ...
                      <form name="formAgregarArea" action="crud/insertarArea.php" method="post" onSubmit="return validacionAgregarArea();">
                           ...
                           <label for="id">Parque:</label>
							...
							<input type="SUBMIT" class="btn-group-vertical" value="Agregar Área"/>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Áreas / Agregar
                            </li>
                        </ol>
                  </div>
                </div>
