    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                      <h1 class="page-header">Agregar Horario Parque</h1>
                      <form action="crud/insertarHorarioParque.php" method="post">


									<br>
                  <br>
                  <label>Parque:</label>
                   <?php $rows = $tra->get_parque();  ?>
                  <select name="codigoParque">
                      ...
                      <br>
                        <label>Hora Inicio:</label>
                          ...
                          <label>Hora Fin:</label>
                            ...
                            <label>Dia:</label>
                              <input type="date" name="dia" max="2016-12-31" min="2016-06-14">
                              <br>
                              <br>
                              ...
                              <select name="periodo">
                              	...
                              	<option value="otros meses">otros meses</option>
                              </select>
                                  ...
                                  <input type="submit" name="submit" id="submit" value="Agregar Horario">
                                  <br><br>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Agregar Horario Parque
                            </li>
                        </ol>
                  </div>
                </div>
