...
require_once 'crud/class.php';
  $tra = new Trabajo();
  $codigoAtraccion=($_POST["atraccion"]);
  $rows = $tra->get_fecha_atraccion($codigoAtraccion);
?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                         ...
                         <form action="horaDisponible.php" method="post"> 
                  <label for="id">Fechas Disponibles:</label>
                  
                          <?php echo "<input type='hidden' name='codigoAtraccion' value='".$codigoAtraccion."'/>"; ?> <br><br>
                       
                        <select name="fechas_disponibles">
                                <?php foreach ($rows as $row) {
                                          echo '<option value="'.$row['ho_codigo'].'">'.$row['ho_dia'].'</option>';
                                }?>
                        </select> <br><br>

                  <label for="fecha_disponible">Fecha de Compra:</label>
                  <input type="date" name="fecha_disponible"/><br><br>
							...
							<td><a href="fastpass.php">Volver Atras</a></td>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="index.html">Inicio </a>
                            </li>
                            <li class="active">
                                <i class="fa fa-file"></i> Eventos Especiales / Fastpass / Fastpass
                            </li>
                        </ol>
                    </div>
                </div>
