                    ...
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                         ...
                         <fieldset style="width:480px" 	>
    		                      <legend>Eliminar Atracción</legend>
	    	                          <form action="crud/eliminarAtraccion.php" method="post" onSubmit="return validacionEliminarAtraccion();">
	    		                             <div>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Atracciones / Eliminar
                            </li>
                        </ol>
                    </div>
                </div>
