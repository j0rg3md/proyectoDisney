            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                      ...
                      <form name="formModificarArea" action="crud/updateArea.php" method="post" onSubmit="return validacionModificarArea();">
                         
                         	 <legend>Modificar Área</legend>
	    	                          
	    		                             <div>
	    			                                 <label for="ides">Área:</label>
                           ...
                           <label for="id">Parque:</label>
							...
							<input type="SUBMIT" class="btn-group-vertical" value="Modificar Área"/>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Áreas / Modificar
                            </li>
                        </ol>
                  </div>
                </div>
