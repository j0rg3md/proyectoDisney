                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                         ...
                         <fieldset  	>
    		                      <legend>Buscar Eventos Especiales</legend>
	    	                          <form action="listaDeEventoEspecial.php" method="post" onSubmit="return validacionEliminarParque()">
	    		                             <div>
	    			                                 <label for="id">Buscar Eventos en:</label>
                                              <?php $rows = $tra->get_lugares();  ?>
                                                ...
                                                <input type="submit" name="eliminar" value="Buscar" />
	    		                              </div>
	    	                         </form>
    	                    </fieldset>
