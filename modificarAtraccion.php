            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                      ...
                      <form name="formModificarAtraccion" action="crud/updateAtraccion.php" method="post" onSubmit="return validacionModificarAtraccion();">
                         
                         	 <legend>Modificar Atracción</legend>
	    	                          
	    		                             <div>
	    			                                 <label for="ides">Atracción:</label>
                                              <?php $rows = $tra->get_eliminarAtraccion();  ?>
					                                          <select name ="codigoA" id="codigoA"><option value="0">Seleccione..
                           ...
                           <label>Extra Magic Hour:</label> 
								         	<input type="checkbox" id="magicS" name="magicS" value="s" > S &nbsp; &nbsp;
                                            <input type="checkbox" id="magicN" name="magicN" value="n" > N <br><br>
                           
                           <label>Entrada Rápida:</label> 
								         	<input type="checkbox" id="entradaS" name="entradaS" value="s" > S &nbsp; &nbsp;
				           					<input type="checkbox" id="entradaN" name="entradaN" value="n" > N <br><br>
                           ...
                           <label>Capacidad:</label>
                            ...
                            <label for="id">Area y Parque:</label>
                                              <?php $rows = $tra->get_area();  ?>
					                                <select  id="codigoAP" name="codigoAP"><option value="0">Seleccione..
						                                   <?php foreach ($rows as $row) 
														   		{
							...
							<input type="SUBMIT" class="btn-group-vertical" value="Modificar Atracción"/>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Atracciones / Modificar
                            </li>
                        </ol>
                  </div>
                </div>
