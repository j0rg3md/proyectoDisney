...
require_once "crud/class.php";
  ...
  $fechaParque = $tra->get_fecha_parque($codigoParque);
  $fechaParqueInicio = $fechaParque["primer_dia"];
  $fechaParqueFin = $fechaParque["ultimo_dia"];
?>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                      <h1 class="page-header">Fechas de Parques</h1>
                      <form action="horarioParque.php" method="post">
                        <?php echo "<input type='hidden' name='codigoParque' value='".$codigoParque."' />"; ?>


									<br>
                  <br>
                  <label>Fechas Disponibles Parque: </label>
                    <?php echo "<input type='date' name='fecha' min=".$fechaParqueInicio." max=".$fechaParqueFin."><br><br>" ?>
                    ...
                    <br>
                      <br>
							...
							<td><a href="consultaHorarioParque.php">Volver Atras</a></td>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="index.html">Inicio</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-file"></i> Horarios / Consulta Horarios Parque
                            </li>
                        </ol>
                  </div>
                </div>
