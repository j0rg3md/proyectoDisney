                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                         ...
                         <fieldset  	>
    		                      <legend>Buscar Hotel</legend>
	    	                          <form action="listaDeHoteles.php" method="post" onSubmit="return validacionEliminarParque()">
	    		                             <div>
	    			                                 <label for="id">Buscar Hotel en:</label>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Hoteles / Información
                            </li>
                        </ol>
                    </div>
                </div>
