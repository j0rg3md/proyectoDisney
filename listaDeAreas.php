                ...
                <div class="row">
					...
					<h1 class="page-header">
                         ...
                         <?php
                            ...
                            $datos=$tra->get_areas($nombreP=($_POST["codigoP"]));
                    ...
                    <table border="1">
                        <tr>
                                ...
                                <p><h4>Nombre: <?php echo $datos[$i]["ar_nombre"];?></h4></p>
                            	
                                <p>Descripción: <?php echo $datos[$i]["ar_descripcion"];?> </p>
                        ...
                        ?>
							...
							<td><a href="buscarAreas.php">Volver Atras</a></td>
                        <ol class="breadcrumb">
                            <li>
