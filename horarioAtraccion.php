...
require_once 'crud/class.php';
  ...
  $fecha = ($_POST['fecha']);
  $rows= $tra->get_horario_atraccion($fecha,$codigoAtraccion);
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                      <h1 class="page-header">Consulta de Horario Atraccion</h1>
                      <form action="crud/eliminarHorarioAtraccion.php" method="post">
                        <?php
                        echo "<input type='hidden' name='codigoAtraccion' value='".$codigoAtraccion."' />";
                        $rows= $tra->get_horario_atraccion($fecha,$codigoAtraccion);
                        ?>
                  <br>
                  <?php
                     echo '<li>Horario: '.$rows['hora_inicio'].' - '.$rows['hora_fin'].' </label>';
                     echo "<input type='hidden' name='codigoHorario' value='".$rows['ho_codigo']."' />";                        
                  ?>
                                          <br>
                                          <br>
