            ...
            <div class="container-fluid">
                ...
                <div class="row">
					...
					<h1 class="page-header">
                            Lista de Atracciones</h1>
                         <?php
                            
                            $datos=$tra->get_atracciones($nombreP=($_POST["codigoP"]));
                    ...
                    <table border="1">
                        <tr>
                                ...
                                <p><h4>Nombre: <?php echo $datos[$i]["a_nombre"];?></h4></p>
                            	
                                <p>Duración: <?php echo $datos[$i]["a_duracion"];?> horas</p>
                                <p>Extra Magic Hour: <?php echo $datos[$i]["a_extra_magic_hour"];?></p>
                                <p>Entrada Rápida: <?php echo $datos[$i]["a_entrada_rapida"];?></p>
                                <p>Capacidad: <?php echo $datos[$i]["a_capacidad"];?> personas</p>
                                <p>Estatura Mínima: <?php echo $datos[$i]["a_estatura_minima"];?> mts</p>
                        ...
                        ?>
							...
							<td><a href="buscarAtracciones.php">Volver Atras</a></td>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="index.html">Inicio</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-file"></i> Atracciones / Información
                            </li>
                        </ol>
