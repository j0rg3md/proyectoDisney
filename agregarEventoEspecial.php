            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                      ...
                      <form name="formAgregarArea" action="crud/insertarEventoEspecial.php" method="post" onSubmit="return validacionAgregarEventoEspecial();">
                           ...
                           <label>Precio:</label>					
								        	<input name="precio" type="numeric" id="precio" size="20" > <br><br>
                                            
                           <label>Duración:</label>					
								        	<input name="duracion" type="numeric" id="duracion" size="20" > <br><br>
                           ...
                           <label for="id">Parque:</label>
							...
							<input type="SUBMIT" class="btn-group-vertical" value="Agregar Evento"/>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Eventos Especiales / Agregar
                            </li>
                        </ol>
                  </div>
                </div>
