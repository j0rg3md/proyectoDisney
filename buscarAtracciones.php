                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                         ...
                         <fieldset  	>
    		                      <legend>Buscar Atracciones</legend>
	    	                          <form action="listasDeAtracciones.php" method="post" onSubmit="return validacionEliminarParque()" >
	    		                             <div>
	    			                                 <label for="id">Buscar Atracción en:</label>
