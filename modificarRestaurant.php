            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                      ...
                      <form name="formModificarRestaurant" action="crud/updateRestaurant.php" method="post" onSubmit="return validacionModificarRestaurant();">
                      
                      		<label for="id">Restaurant:</label>
                                              <?php $rows = $tra->get_eliminarRestaurant();  ?>
					                                <select  id="codigoR" name="codigoR"><option value="0">Seleccione..
						                                   <?php foreach ($rows as $row) 
														   		{
																	echo '<option value="'.$row['r_codigo'].'"> '.$row['r_nombre'].'</option>';
						                                         }?>
                                                                				          </option>
                                                     </select><br><br>    
                           ...
                           <label>Precio Máximo:</label> 
							...
							<input type="SUBMIT" class="btn-group-vertical" value="Modificar Restaurant"/>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Restaurant / Modificar
                            </li>
                        </ol>
                  </div>
                </div>
