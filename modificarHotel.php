                    ...
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                            Modificar Hotel
                         		...
                         		<form name="formModificarParque" action="crud/updateHotel.php" method="post" onSubmit="return validacionModificarHotel();">
    		                      <legend>Modificar Hotel</legend>
	    	                          
	    		                            
	    			       <label for="id">Hotel:</label>
                                              
					                                          
	    			                                          <?php $rows = $tra->get_eliminarHotel();  ?>
					                                          <select  id="codigoH" name="codigoH"><option value="0">Seleccione..
                           ...
                           <label>Dirección:</label>								        
								         	<input type="text" id="direccion" name="direccion" size="20" > <br><br>
								        
				           <label>Fecha de Fundación:</label>
                                        	<input type="date" id="fechaF" name="fecha_fundacion" size="20" > <br><br>
				           
				           
                            <label for="id">Parque:</label>
                                              <?php $rows = $tra->get_lugares();  ?>
					                                          <select name ="codigoP" id="codigoP"><option>Seleccione..
						                                                  <?php foreach ($rows as $row) {
							                                                         echo '<option value="'.$row['lu_codigo'].'">'.$row['lu_nombre'].'</option>';
						                                                  }?>
                                                                          </option>
								        	...
								        	<input type="SUBMIT" class="btn-group-vertical" value="Modificar Hotel"/>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Hoteles / Modificar
                            </li>
                        </ol>
                  </div>
                </div>
