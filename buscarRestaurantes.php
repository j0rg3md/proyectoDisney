                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                         ...
                         <fieldset  	>
    		                      <legend>Buscar Restaurantes</legend>
	    	                          <form action="listaDeRestaurantes.php" method="post" onSubmit="return validacionEliminarParque()">
	    		                             <div>
	    			                                 <label for="id">Buscar Restaurantes en:</label>
