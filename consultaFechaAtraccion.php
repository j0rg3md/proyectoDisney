...
require_once 'crud/class.php';
  ...
  $fechaAtraccion = $tra->get_rango_fecha_atraccion($codigoAtraccion);
  $fechaAtraccionInicio = $fechaAtraccion['primer_dia'];
  $fechaAtraccionFin = $fechaAtraccion['ultimo_dia'];
?>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                      <h1 class="page-header">Consulta Fecha Atracción</h1>
                      <form action="horarioAtraccion.php" method="post">
                  ...
                  <label>Fechas Disponibles Parque: </label>
                    <?php echo "<input type='date' name='fecha' min=".$fechaAtraccionInicio." max=".$fechaAtraccionFin."><br><br>" ?>
                    ...
                    <br>
                      <br>
							...
							<td><a href="consultaHorarioAtraccion.php">Volver Atras</a></td>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="index.html">Inicio</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-file"></i> Consulta Fecha Atracción
                            </li>
                        </ol>
                  </div>
                </div>
