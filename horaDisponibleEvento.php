...
require_once 'crud/class.php';
  ...
  $fecha = ($_POST["fechas_disponibles"]);
  $rows = $tra->get_horarios_evento($fecha);
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                         ...
                         <form action="crud/entradaEvento.php" method="post">
									<br>
                  <br>

                <?php echo "<input type='hidden' name='codigoEvento' value='".$codigoEvento."' />";
                echo "<h3 class='page-header'> Fecha: ".$fecha." </h3>";
                ?>
                <?php echo "<input type='hidden' name='codigoFecha' value='".$fecha."' />";?>
                  <label for="Hora">Horas del evento:</label>
                  <select name="codigoFecha">
                          <?php foreach ($rows as $row) {
                                    echo '<option value="'.$row['he_codigo'].'">'.$row['horario'].'</option>';
                          }?>
                  </select>
