                ...
                <div class="row">
					...
					<h1 class="page-header">
                         ...
                         <?php
                            ...
                            $datos=$tra->get_hoteles($nombreP=($_POST["codigoP"]));
                    ...
                    <table border="1">
                        <tr>
                                ...
                                <p><h4>Nombre: <?php echo $datos[$i]["lu_nombre"];?></h4></p>
                            	
                                <p>Descripción: <?php echo $datos[$i]["lu_descripcion"];?> </p>
                                <p>Dirección: <?php echo $datos[$i]["lu_direccion"];?> </p>
                                <p>Fecha Fundado: <?php echo $datos[$i]["lu_fecha_fundado"];?> </p>
                                <p>Tipo: <?php echo $datos[$i]["lu_tipo"];?> </p>
                        ...
                        ?>
							...
							<td><a href="buscarHotel.php">Volver Atras</a></td>
                        <ol class="breadcrumb">
                            <li>
