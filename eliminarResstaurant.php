                    ...
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                         ...
                         <fieldset style="width:480px" 	>
    		                      <legend>Eliminar Restaurant</legend>
	    	                          <form action="crud/eliminarRestaurant.php" method="post" onSubmit="return validacionEliminarParque();">
	    		                             <div>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Restaurantes / Eliminar
                            </li>
                        </ol>
                    </div>
                </div>
