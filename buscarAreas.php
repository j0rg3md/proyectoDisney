                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                         ...
                         <fieldset  	>
    		                      <legend>Buscar Áreas</legend>
	    	                          <form action="listaDeAreas.php" method="post" onSubmit="return validacionEliminarParque()">
	    		                             <div>
	    			                                 <label for="id">Buscar Áreas en:</label>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Áreas / Información
                            </li>
                        </ol>
                    </div>
                </div>
