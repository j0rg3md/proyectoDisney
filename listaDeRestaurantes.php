            ...
            <div class="container-fluid">
                ...
                <div class="row">
					...
					<h1 class="page-header">
                            Lista de Restaurantes</h1>
                         <?php
                            
                            $datos=$tra->get_restaurantes($nombreP=($_POST["codigoP"]));
                    ...
                    <table border="1">
                        <tr>
                                ...
                                <p><h4>Nombre: <?php echo $datos[$i]["r_nombre"];?></h4></p>
                            	
                                <p>Descripción: <?php echo $datos[$i]["r_descripcion"];?> </p>
                                <p>Tipo de Restaurant: <?php echo $datos[$i]["r_tipo_restaurant"];?></p>
                                <p>Reservación: <?php echo $datos[$i]["r_reserva"];?></p>
                                <p>Precio Mínimo: <?php echo $datos[$i]["r_precio_min"];?> $</p>
                                <p>Precio Máximo: <?php echo $datos[$i]["r_precio_max"];?> $</p>
                        ...
                        ?>
							...
							<td><a href="buscarRestaurantes.php">Volver Atras</a></td>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="index.html">Inicio</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-file"></i> Restaurantes / Información
                            </li>
                        </ol>
