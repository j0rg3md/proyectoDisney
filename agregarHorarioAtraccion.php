    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                      <h1 class="page-header">Agregar Horario Atraccion</h1>
                      <form action="crud/insertarHorarioAtraccion.php" method="post">
                  ...
                  <label>Atraccion:</label>
                        ...
                        <?php $rows = $tra->get_atraccion_atracciones();  ?>
                          <select name="codigoAtraccion">
                            <?php foreach ($rows as $row) {
							                 echo '<option value="'.$row['a_codigo'].'">'.$row['atraccion'].'</option>';
						                }?>
                  ...
                  <label>Hora Inicio:</label>
                        ...
                        <label>Dia:</label>
                        <input type="date" name="dia" min="2016-06-14">
                        <br>
                        <br>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Agregar Horario Atracción
                            </li>
                        </ol>
                  </div>
                </div>
