...
$sql ="insert into jnf_visitante (v_nombre,v_apellido,v_segundo_nombre,v_fecha_nac,v_genero,v_codigo_postal,v_correo,v_direccion,lugar) values (
'".$nombre."','".$apellido."','".$segundoNombre."','".$fecha_nacimiento."','".$genero."',".$codigoPostal.",'".$correo."','".$direccion."',".$pais.");";
$res=pg_exec($sql);
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                         ...
                         <form action="insertarAcompanante.php" method="post">
                           <?php

                                echo "<input type='hidden' name='numeroAmigos' value='".$numeroAmigos."' />";
                                ...
                                echo "<input type='hidden' name='codigoPostal' value='".$codigoPostal."' />";
                                echo "<input type='hidden' name='direccion' value='".$direccion."' />";

                                for ($i = 0; $i < $numeroAmigos; $i++) {
                                  echo "<h3 class='page-header'> Visitante ".(1+$i)." </h3>";
                                  echo "<li>Nombre
                                    <input type='text' name='nombre".$i."' value = 'Jorge' ><br>
                                    <br>";
                                  echo "<li>Apellido
                                    <input type='text' name='apellido".$i."' value = 'Marin'><br>
                                    <br>";
                                 echo "<li>Segundo nombre
                                     <input type='text' name='segundoNombre".$i."' value ='Luis' ><br>
                                     <br>";
                                  echo " <li> Fecha de nacimiento
                                  <input type='date' name='fecha_nacimiento".$i."'><br>";
                                  echo " <input type='radio' name='genero".$i."' value='m' checked> Masculino<br>";
                                  echo " <input type='radio' name='genero".$i."' value='f' checked> Femenino<br>";

                          }?>

           									<hr>
           									<INPUT TYPE="SUBMIT" VALUE="Registrar Acompañantes"/>
           									<hr>
                          </form>
