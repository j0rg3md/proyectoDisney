            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                      ...
                      <form name="formModificarArea" action="crud/updateEventoEspecial.php" method="post" onSubmit="return validacionModificarEventoEspecial();">
                         
                         	 <legend>Modificar Evento Especial</legend>
	    	                          
	    		                             <div>
	    			                                 <label for="ides">Evento:</label>
                                              <?php $rows = $tra->get_eliminarEventoEspecial();  ?>
					                                          <select name ="codigoA" id="codigoA"><option value="0">Seleccione..
						                                                  <?php foreach ($rows as $row) {
							                                                         echo '<option value="'.$row['ee_codigo'].'">'.$row['eventos'].'</option>';
						                                                  }?>
                                                                          </option>
                                                              </select>
                                                              <br><br>
                           ...
                           <label for="id">Parque:</label>
                                              <?php $rows = $tra->get_lugares();  ?>
					                                <select  id="codigoP" name="codigoP"><option value="0">Seleccione..
						                                   <?php foreach ($rows as $row) 
														   		{
																	echo '<option value="'.$row['lu_codigo'].'"> '.$row['lu_nombre'].'</option>';
						                                         }?>
                                                                				          </option>
                                                     </select><br><br>     
                                            
                           
							<input type="SUBMIT" class="btn-group-vertical" value="Modificar Evento Especial"/>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Eventos Especiales / Modificar
                            </li>
                        </ol>
                  </div>
                </div>
