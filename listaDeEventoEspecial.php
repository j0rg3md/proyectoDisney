            ...
            <div class="container-fluid">
                ...
                <div class="row">
					...
					<h1 class="page-header">
                            Lista de Eventos Especiales</h1>
                         <?php
                            
                            $datos=$tra->get_eventosEspeciales($nombreP=($_POST["codigoP"]));
                    ...
                    <table border="1">
                        <tr>
                                ...
                                <p><h4>Nombre: <?php echo $datos[$i]["ee_nombre"];?></h4></p>
                            	<img src="images/animal_kingdom13.jpg"/>
                                <p>Descripcion: <?php echo $datos[$i]["ee_descripcion"];?></p>
                                <p>Precio: <?php echo $datos[$i]["ee_precio"];?> $</p>
                                <p>Fecha Culminación: <?php echo $datos[$i]["ee_fecha_culminacion"];?></p>
                                <p>Duración: <?php echo $datos[$i]["ee_duracion"];?> minutos</p>
                        ...
                        ?>
							...
							<td><a href="buscarEventoEspecial.php">Volver Atras</a></td>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="index.html">Inicio</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-file"></i> Eventos Especiales / Información
                            </li>
                        </ol>
